...
return [
    ...
    'search_pagination'     => 10, // количество результатов при выводе результатов поиска тендеров
    'my_tenders_pagination' => 10, // количество результатов на странице при выводе списка собственных тендеров
    'rejected_pagination'   => 10, // количество результатов на странице при выводе списка отклонённых тендеров (все тендеры которые сам отклонил)
    'rejections_pagination' => 20, // количество результатов на странице при выводе списка организаций, отклонивших конкретный тендер
