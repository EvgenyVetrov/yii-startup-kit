...
/**
 * SearchBlogCategories represents the model behind the search form of `modules\blog\models\backend\BlogCategories`.
 */
class SearchBlogCategories extends BlogCategories
{
    /**
     * @inheritdoc
     */
